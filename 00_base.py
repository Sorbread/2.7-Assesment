...
def get_rider_information(races):
    ...
    for i in range(races):
        placing = get_int(f"Please enter your placing for race {i+1} (enter 0 if did not compete): ",0,MAX_PLACING)
...
race_amount = get_int("Please enter the amount of races your teams will be competing in: ",0)
riders_per_team = get_int("Please enter the number of riders per team.")
